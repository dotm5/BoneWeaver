...
from boneweaver.core.overrides import armature_structural_fingerprint, upsert_terminal_override
...
class PlannerSettingsTests(unittest.TestCase):
    ...
    def test_explicit_manual_override_is_frozen_as_authoritative_solution(self) -> None:
        ...
        override = upsert_terminal_override(
            bpy.context.scene.boneweaver_settings.terminal_overrides,
    ...
    def test_legacy_unscoped_override_warns_and_is_not_applied(self) -> None:
        legacy = bpy.context.scene.boneweaver_settings.terminal_overrides.add()
        ...
        migration = [issue for issue in plan.issues if issue.code == "BONEWEAVER_LEGACY_OVERRIDE_UNSCOPED"]
