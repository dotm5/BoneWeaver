...
|---|---|---|
| Python syntax | `python -m compileall -q boneweaver tests tools` | Pass |
...
| Extension build | Blender `--factory-startup --command extension build --source-dir boneweaver --output-dir dist` | Pass |
...
- File: `dist/boneweaver-0.1.0.zip`
- Bytes: 47,874
