...
def main():
    ...
    import boneweaver
    from boneweaver.core.export_contract import file_signature, load_snapshot_payload
    from boneweaver.core.runtime_store import get_performance, get_plan
    ...
    output_blend = output_dir / "x1-boneweaver-converted.blend"
    ...
    try:
        ...
        export_result = bpy.ops.boneweaver.export_conversion(filepath=str(output_blend))
        ...
        print("BONEWEAVER_REAL_BACKEND_RESULT", result["status"], result.get("error", ""))
        sys.stdout.flush()
        sys.stderr.flush()
        os._exit(exit_code)
