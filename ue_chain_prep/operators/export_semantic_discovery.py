...
class UECP_OT_export_semantic_discovery(bpy.types.Operator, ExportHelper):
    ...
    def execute(self, context):
        try:
            ...
            context.window_manager.uecp_runtime.last_error = "UECP_SEMANTIC_EXPORT_FAILED"
            return {"CANCELLED"}
        context.window_manager.uecp_runtime.last_error = ""
        return {"FINISHED"}
