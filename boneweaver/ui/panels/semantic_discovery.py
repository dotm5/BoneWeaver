...
class BONEWEAVER_PT_semantic_discovery(bpy.types.Panel):
    bl_idname = "BONEWEAVER_PT_semantic_discovery"
    ...
    def draw(self, context):
        ...
        for item in wm.boneweaver_semantic_chain_items:
            box = layout.box()
