...
TRANSLATIONS = {
    "zh_HANS": {
        ...
        ("Operator", "Restore BONEWEAVER Snapshot"): "恢复 BONEWEAVER 快照",
        ("Operator", "Export BONEWEAVER Diagnostic Report"): "导出 BONEWEAVER 诊断报告",
        ("Operator", "Clear BONEWEAVER Runtime"): "清除 BONEWEAVER 运行状态",
