...
def apply_plan(context, plan, *, validator=None):
    ...
    with ContextStateGuard(context):
        try:
            ...
            text_name = f"BONEWEAVER_SNAPSHOT::{snapshot_id}"
            payload = {
                "kind": "boneweaver.snapshot", "schema_version": plan.schema_version,
            ...
            for proposal in plan.proposals:
                ...
                if "BONEWEAVER_KEEP_NUMERIC_ROLL" in proposal.issue_codes:
